...
from .pass_spare import PassSparseEnv, PassSparseHardEnv
...
CONFIGURATIONS = {
    ...
    'MultiGrid-MultiTargetEmpty-4x4-v0': (MultiTargetEmptyEnv, {'size': 4}),
    'MultiGrid-MultiTargetEmpty-8x8-v0': (MultiTargetEmptyEnv, {'size': 8}),
    'MultiGrid-MultiTargetEmpty-16x16-v0': (MultiTargetEmptyEnv, {'size': 16}),
    'MultiGrid-MultiTargetEmpty-3Agent-12x12-v0': (MultiTargetEmptyEnv, {'size': 12, 'num_agents': 3}),
    'MultiGrid-MultiTargetEmpty-4Agent-16x16-v0': (MultiTargetEmptyEnv, {'size': 16, 'num_agents': 4}),
    # Variants with restricted action space (only turn left and forward)
    'MultiGrid-MultiTargetEmpty-8x8-TurnForward-v0': (MultiTargetEmptyEnv, {'size': 8, 'num_agents': 2, 'only_turn_and_forward': True}),
    'MultiGrid-MultiTargetEmpty-16x16-TurnForward-v0': (MultiTargetEmptyEnv, {'size': 16, 'num_agents': 2, 'only_turn_and_forward': True}),
    'MultiGrid-MultiTargetEmpty-3Agent-12x12-TurnForward-v0': (MultiTargetEmptyEnv, {'size': 12, 'num_agents': 3, 'only_turn_and_forward': True}),
    'MultiGrid-MultiTargetEmpty-4Agent-16x16-TurnForward-v0': (MultiTargetEmptyEnv, {'size': 16, 'num_agents': 4, 'only_turn_and_forward': True}),
    ...
    'MultiGrid-PassSparse-12x12-v0': (PassSparseEnv, {'size': 12, 'num_agents': 2}),
    'MultiGrid-PassSparse-16x16-v0': (PassSparseEnv, {'size': 16, 'num_agents': 2}),
    'MultiGrid-PassSparseHard-12x12-v0': (PassSparseHardEnv, {'size': 12, 'num_agents': 2}),
    'MultiGrid-PassSparseHard-16x16-v0': (PassSparseHardEnv, {'size': 16, 'num_agents': 2}),
    'MultiGrid-PassSparseHard-8x8-v0': (PassSparseHardEnv, {'size': 8, 'num_agents': 2}),
    'MultiGrid-PushBox-16x16-v0': (PushBoxEnv, {'size': 16, 'num_agents': 2}),

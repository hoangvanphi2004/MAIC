...
if __name__ == '__main__':
    ...
    parser.add_argument('--env_id', type=str, default='MultiGrid-PassSparse-8x8-v0', 
    ...
    parser.add_argument('--steps_per_update', type=int, default=4, help='Update network every N episodes')
    parser.add_argument('--updates_num', type=int, default=4, help='Updates per update step')
